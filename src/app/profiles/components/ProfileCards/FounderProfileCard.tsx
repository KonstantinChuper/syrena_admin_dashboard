...
export function FounderProfileCard({ profile, onEdit, onDelete }: ProfileCardProps) {
  return (
    <Card className="overflow-hidden border border-border/40 bg-background/60 backdrop-blur-lg flex flex-col h-full">
      ...
      <CardContent className="space-y-3 flex-grow">
        ...
        {profile.customerGroups && profile.customerGroups.length > 0 && (
          <div>
            <p className="text-sm font-medium mb-1">Customer Groups</p>
            <div className="flex flex-wrap gap-1">
              {profile.customerGroups.map((group) => (
